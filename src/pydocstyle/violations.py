...
class ErrorRegistry:
    ...
    def to_rst(cls) -> str:
        ...
        for group in cls.groups:
            ...
            table += blank_line
            table += (
                "|" + "**{}**".format(group.name).center(max_len + 9) + "|\n"
            )
            table += blank_line
            for error in group.errors:
                table += sep_line
...
D415 = D4xx.create_error("D415", "First line should end with a period,"
